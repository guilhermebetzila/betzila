...
>
  Registrar-se
      ...
      <section className="w-full max-w-4xl px-6 mt-14 mx-auto text-center leading-relaxed text-xl sm:text-2xl space-y-6">
            ...
            <div className="flex gap-8 min-w-max">
              {[
                ...
                },
                {
                  ...
                  cargoEstilo: 'text-green-700 font-extrabold tracking-widest',
                },
                {
                  nome: 'Carla Mendes',
                ...
                <div
                  key={nome}
                  className="flex-shrink-0 w-48 sm:w-56 bg-gray-100 rounded-xl p-4 shadow-lg border-4 border-green-600 hover:scale-105 transition-transform duration-300 cursor-default select-none"
                >
                  <div className="relative w-full h-48 rounded-lg overflow-hidden border-4 border-green-600 shadow-md">
                    <Image
                      src={imagem}
                      alt={`Foto de ${nome}`}
                      fill
        ...
        <div className="bg-gray-100 border border-green-600 rounded-2xl shadow-2xl mt-10 py-10 px-6 text-center space-y-6 max-w-3xl mx-auto">
          <h3 className="text-3xl font-bold text-green-700 select-none">🔓 3 Passos Simples para sua Virada</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            {[['1 Semana', ganhoSimples.semana, ganhoIndicacao.semana, ganhoIndicado.semana],
              ...
              ['3 Meses', ganhoSimples.tresMeses, ganhoIndicacao.tresMeses, ganhoIndicado.tresMeses]].map(([label, simples, direta, indireta], i) => (
                <div key={i} className="bg-gradient-to-b from-yellow-400 to-yellow-500 text-black rounded-lg p-4 shadow-lg transform transition-transform hover:scale-105">
            ...
            <tbody>
              {ranking.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 text-green-700 font-semibold text-right">
        ...
        <div className="max-w-3xl mx-auto px-4 mt-14 text-center">
          <h2 className="text-green-700 font-extrabold text-3xl sm:text-4xl select-none mb-4">
          ...
          <p className="text-black text-lg">
            Não entre para ver. <strong className="text-green-700">Entre para mudar sua vida.</strong>
          </p>
        ...
        <section className="max-w-4xl mx-auto px-6 mt-20 bg-gray-100 rounded-xl shadow-lg py-8 text-black">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div className="bg-gray-300 rounded-lg p-4 border-2 border-green-700">
        ...
        <footer className="w-full bg-gray-200 text-black py-16 mt-20 border-t border-gray-400 select-none">
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 px-6 text-sm sm:text-base">
            <div>
              <h3 className="font-extrabold mb-6 text-purple-700 uppercase tracking-wide">🔹 SOBRE NÓS</h3>
            ...
            <div>
              <h3 className="font-extrabold mb-6 text-purple-700 uppercase tracking-wide">🔹 PRODUTOS</h3>
              <ul className="space-y-3 leading-relaxed">
            ...
            <div>
              <h3 className="font-extrabold mb-6 text-purple-700 uppercase tracking-wide">🔹 SUPORTE</h3>
              <ul className="space-y-3 leading-relaxed">
            ...
            <div>
              <h3 className="font-extrabold mb-6 text-purple-700 uppercase tracking-wide">🔹 LEGALIDADE</h3>
              <ul className="space-y-3 leading-relaxed">

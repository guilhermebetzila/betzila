...
export default function Home() {
  ...
  return (
    <main className="flex flex-col justify-start min-h-screen w-full overflow-x-hidden">
      <div className="w-full max-w-6xl mx-auto px-4">
        ...
        {/* Conteúdo principal */}
        <div className="text-center text-white space-y-6 mt-6">
          ...
          <p className="text-green-400 font-bold text-xl">
            Agora imagine que você pode investir nela.
          </p>
          ...
          <p className="text-white">
            Não entre para ver.{' '}
            <strong className="text-green-400">Entre para mudar sua vida.</strong>
          </p>
